...
try:
    ...
    checkpoint_path = os.path.abspath(os.path.join(os.path.dirname(__name__), 'forward/model/checkpoints/model_pca.ckpt'))
    config_path = os.path.join(get_config_path(), 'model/forward_emulator_pca.yaml')
